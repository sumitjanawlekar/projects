...
//		String serviceCenterName = serviceCenter.getServiceCenterName();
	...
	public String processForm(@ModelAttribute("booking") Booking booking, Customer customer, HttpSession session, CustomerDAO customerDao, ServiceCenterDAO serviceCenterDao) {
